...
f'(t) = \frac{df}{dt}
$$
- উদাহরণ: গাড়ির ক্ষেত্রে, \( s(t) \) = দূরত্ব → ডেরিভেটিভ \( v(t) = \frac{ds}{dt} \) = সেই মুহূর্তের **সর্বক্ষণিক গতিবেগ**।
...
- সারসংক্ষেপে:  
$$
\text{সর্বক্ষণিক পরিবর্তন} = \text{ডেরিভেটিভ} = \text{Instantaneous Rate of Change}
$$
...
$$
10s থেকে 15s এ 80m → \( v_{\text{avg}} = 16 \text{ m/s} \)

- **সর্বক্ষণিক গতিবেগ:** নির্দিষ্ট মুহূর্তে (t = 12.5s)  
$$
v(12.5) = \frac{ds}{dt} 
$$
